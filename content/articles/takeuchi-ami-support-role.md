...
新潟大学経済学部3年生。新潟県新潟市出身。「次世代ベース」内のプロジェクト「コメクション（Comnection）」に所属し、おにぎりやお米を通じて新潟の魅力を発信する活動に従事。商品開発から販売、子ども食堂でのイベント運営などに携わる。現在はプロジェクトの第一線を後輩に引き継ぎつつ、自身の経験を活かしてサポート役として活動を見守っている。リーダーシップよりも、人の動きを観察し支える「縁の下の力持ち」としての役割に情熱を注いでいる。
...
参加したプロジェクト「コメクション」で、私は最初にキッチンカー販売のリーダーを任されました。
